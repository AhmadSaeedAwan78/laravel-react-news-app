...
Route::middleware('auth:api')->group(function () {
    ...
    Route::prefix('news')->group(function() {
        ...
        Route::get('categories',   [NewsController::class, 'getCategories'])->name('news.getCategories');
        Route::get('countries',    [NewsController::class, 'getCountries'])->name('news.getCountries');
        Route::get('languages',    [NewsController::class, 'getLanguages'])->name('news.getLanguages');
